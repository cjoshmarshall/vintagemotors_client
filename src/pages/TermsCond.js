...
function TermsCond() {
    ...
    return (
        ...
        <div className='termscond'>
            <div className='termscond_container'>
                <div className='termscond_titleContainer'>
                    <h2 className='termscond_title'>Terms & Condition </h2>
                </div>

                <h4 className='termscond_subtitle'>
                    Payment process
                </h4>
                <div className='termscond_content'>
                    Rental charges can be paid online or offline after the rental period.
                </div>
                ...
                <div className='termscond_content'>
                    Lessee has to be present to pick up the bike.
                </div>
                <div className='termscond_content'>
                ...
                <div className='termscond_content'>
                    Lessee has to inform us 2 hrs in advance before the end of the Period.
                </div>
                <div className='termscond_content'>
                    The drop-off location will be the same as the pick-up location.
                </div>
                ...
                <div className='termscond_content'>
                    Helmets will be charged @ 20/day.
                </div>
                <div className='termscond_content'>
                ...
                <div className='termscond_content'>
                    Only one helmet will be provided per person, any extras will be charged at Rs. 20 per 24 hours
                </div>
                ...
                <div className='termscond_endcontent'>
